...
} from "./chunk-LZYUMSIH.js";
import {
  findIonContent,
  getScrollElement,
  printIonContentErrorMsg
} from "./chunk-MGEB6UH5.js";
...
import {
  attachComponent,
  detachComponent
} from "./chunk-D5W32P57.js";
import {
  createColorClasses,
  hostContext
} from "./chunk-7F6NIWSM.js";
import {
  shouldUseCloseWatcher
} from "./chunk-WDKM3RWV.js";
import {
  transition
} from "./chunk-VJSP3KER.js";
import {
  clamp,
  componentOnReady,
  hasLazyBuild,
  ...
  componentDidLoad() {
    {
      rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-CWbP1eJz-U6FLOACZ.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-7t9T91bG-DKX5AWJB.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-C3lNp93k-6ELWT3B3.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./hardware-back-button-DcH0BbDp-2DHDQGJ3.js");
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./swipe-back-VdaUzLWy-NBJCRQUR.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
...
@ionic/core/dist/esm/ion-app_8.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-app_8.entry-HWJROIVA.js.map
